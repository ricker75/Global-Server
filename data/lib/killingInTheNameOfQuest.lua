...
tasks =
{
	...
	[36] = {killsRequired = 500, raceName = "Medusa", level = {130, 9999}, premium = true, creatures = {"medusa"}, rewards = {{type = "exp", value = {40000}},{type = "achievement", value = {"The Serpent's Bride"}},{type = "storage", value = {35020, 1}},{type = "points", value = {5}}}},	
	...
	[44] = {killsRequired = 6666, raceName = "Demons", level = {130, 9999}, rank = RANK_ELITEHUNTER, norepeatable = true, premium = true, creatures = {"demon"}, rewards = {{type = "storage", value = {41300, 1}}}},																																	
}
