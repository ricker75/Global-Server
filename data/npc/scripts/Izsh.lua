...
function creatureSayCallback(cid, type, msg)
	...
	elseif(msgcontains(msg, "yes")) then
		if(npcHandler.topic[cid] == 1) then
				npcHandler:say({"Fine, zo let'z prozeed. You uzed forged documentz to enter our zity, killed zeveral guardz who enjoyed a quite excluzive and expenzive training, deztroyed rare magical devizez in ze pozzezzion of ze emperor. ...",
				...
				"You will find your rewardz in one of ze old zupply zellarz. Beware of ze ratz zough. ..."}, cid)
				setPlayerStorageValue(cid, 1050, 30)
				setPlayerStorageValue(cid, 15180, 2) -- quest log mission 12
