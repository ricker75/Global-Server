...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'documents') then
		if player:getStorageValue(Storage.thievesGuild.Mission04) == 2 then
			...
			selfSay("You need some forged documents? But I will only forge something for a friend. ...", cid)
			npcHandler:say("The nomads at the northern oasis killed someone dear to me. Go and kill at least one of them, then we talk about your document.", cid)
