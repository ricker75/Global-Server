...
function greetCallback(cid)
	if(getPlayerStorageValue(cid, 1050) == 23) then
...
local function creatureSayCallback(cid, type, msg)
	...
	if(getPlayerStorageValue(cid, 1050) == 23) then
		if(msg == "SOLOSARASATIQUARIUM") then
			selfSay("Dragon dreams are golden. ...", cid)
			selfSay("A broad darkness surrounds you as if a heavy curtain is closing before your eyes. After what seems like minutes of floating through emptiness, you get the feeling as if a hole opens in the dark before you. ...", cid)
			selfSay("The hole grows larger, you cannot close your eyes. An unimaginable black. Deeper and darker than any nothingness you could possibly imagine drags you into it. ...", cid)
			selfSay("You feel as if you cannot breathe anymore. The very second you let loose of your consciousness, you sense all heaviness around you lifted. ...", cid)
			selfSay("You dive into an ocean of emerald light. Feeling like born anew the colour around you is almost overwhelming. Countless objects of all shapes and sizes are dashing past you. Racing against each other, millions are clashing in the distance. ..", cid)
			selfSay("The loudness of the gargantuan spectacle around you bursts your hearing, yet you absorb all the sounds around you. ...", cid)
			selfSay("As several large obstacles move aside directly in front of you, an intense bright centre leaps into your view. Though you cannot perceive how fast you are, your pace seems too slow. ...", cid)
			selfSay("Ever decelerating, you ultimately approach a middle in this chaos of tones of green. ...", cid)
			selfSay("As you come closer to it, yellowish shades of orange embrace you, softer shapes emerge and you almost forget the mayhem before. In warm comfort you see what lies in the heart of it all. ...", cid)
			selfSay("A majestic dragon in his sleep is surrounded by what seems the warmth and energy of a thousand suns. The tranquillity of its sight makes you smile gently. ...", cid)
			selfSay("You feel a perfect mixture of joy, compassion and sudden peacefulness. Bright xanthous impressions of topaz, orange and white welcome you at the final halt of your journey. ...", cid)
			selfSay("Dragon dreams are golden. ...", cid)
		...
		elseif(string.lower(msg) == "use attachment" and npcHandler.topic[cid] == 14) then
			npcHandler:say({"Avoiding the bright light, you carefully put the attachment on top of the strange socket. ... ",
			"As your eyes adjust to the sudden reduction of brightness, you see the giant wings of the gate before you move to the side. You can also make out something shiny on the ground."}, cid)
		...
		elseif(string.lower(msg) == "north" and npcHandler.topic[cid] == 16) then
			selfSay("Your path to the north is open. You pass the gigantic gate wings to your left and right as you advance. After about an hour of travel you hear a slight rustling in the distance. You head further into that direction. ... ", cid)
		...
		elseif(string.lower(msg) == "use model" and npcHandler.topic[cid] == 17) then
			selfSay("You lunge out and throw the model far into the water. As nothing happens, you turn your back to the ocean. ... ", cid)
			selfSay("The very moment you walk down the dune to head back south, rays of light burst over your head in a shock wave that makes you tumble down the rest of the hill. ... ", cid)
		...
		elseif(string.lower(msg) == "take sapphire" and (npcHandler.topic[cid] == 25 or npcHandler.topic[cid] == 24)) then
		...
		elseif(string.lower(msg) == "use mirror" and npcHandler.topic[cid] == 33) then
			...
			setPlayerStorageValue(cid, 1050, 24)
		end
	elseif(getPlayerStorageValue(cid, 1050) == 24) then
		...
		elseif(msgcontains(msg, "mission") and npcHandler.topic[cid] == 1) then
			selfSay("Aaaah... free at last. Hmmm. ...", cid)
			selfSay("I assume you need to get through the gate to reach the evildoer. I can help you if you trust me, wayfarer. I will share a part of my mind with you which should enable you to step through the gate. ...", cid)
			npcHandler:say("This procedure may be exhausting. Are you prepared to receive my key?", cid)
			npcHandler.topic[cid] = 2
		elseif(msgcontains(msg, "yes") and npcHandler.topic[cid] == 2) then
			selfSay("SAETHELON TORILUN GARNUM. ... ", cid)
			selfSay("SLEEP. ...", cid)
			selfSay("GAIN. ...", cid)
			selfSay("RISE. ...", cid)
			selfSay("The transfer was successful. ...", cid)
			...
			setPlayerStorageValue(cid, 1050, 25)
			setPlayerStorageValue(cid, 10844, 2) -- quest log and acess north gate	
