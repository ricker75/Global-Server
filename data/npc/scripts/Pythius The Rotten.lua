...
function creatureSayCallback(cid, type, msg)
	...
	elseif (msgcontains(msg, "undead") and npcHandler.topic[cid] == 1) then
	...
	elseif (msgcontains(msg, "treasure") and npcHandler.topic[cid] == 2) then
	...
	elseif (msgcontains(msg, "yes") and npcHandler.topic[cid] == 3) then
		...
		npcHandler:say("EVERYTHING YOU CARRY WITH YOU CAN ALSO BE FOUND IN MY TREASURE. BRING ME SOMETHING I DON'T OWN!!!", cid)
		npcHandler.topic[cid] = 4
	elseif (msgcontains(msg, "offer") and npcHandler.topic[cid] == 4) then
	...
	elseif (msgcontains(msg, "golden mug") and npcHandler.topic[cid] == 6) then
