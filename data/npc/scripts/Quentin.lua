...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yuri") then
		npcHandler:say("Yuri Lagrotta que fez o servidor e nao retire os creditos.", cid)
	elseif msgcontains(msg, "wooden stake") then
		if player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) < 1 then
			selfSay("A blessed stake to defeat evil spirits? I do know an old prayer which is said to grant sacred power and to be able to bind this power to someone, or something. ...", cid)
			selfSay("However, this prayer needs the combined energy of ten priests. Each of them has to say one line of the prayer. ...", cid)
			selfSay("I could start with the prayer, but since the next priest has to be in a different location, you probably will have to travel a lot. ...", cid)
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome, adventurer |PLAYERNAME|! If you are new in Tibia, ask me for help. If you need {healing} or {blessings} I can help you with that.")
