...
keywordHandler:addKeyword({'necromants nectar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "You are not the first one to ask about that. Am I the only one that preferes wine to such disgusting stuff?"})
...
keywordHandler:addKeyword({'Chester Kahs'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I never found any rumour concerning him, isn't that odd?"})
...
keywordHandler:addKeyword({'sinister strangers'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Just last week a one eyed man, who had a room at Frodo's, met him in the middle of the night."})
...
keywordHandler:addKeyword({'rumours'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "You know a rumour? TELL ME! TELL ME! TELL ME!"})
keywordHandler:addKeyword({'anything'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Fascinating! Absolutely fascinating!"})
