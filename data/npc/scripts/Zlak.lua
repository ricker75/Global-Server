...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if(getPlayerStorageValue(cid, 1060) == 22) then
			...
			selfSay("Zo we have to ztrike fazt and quickly. You will have to eliminate zome high ranking key officialz. I zink killing four of zem should be enough. ...", cid)
		...
		elseif(getPlayerStorageValue(cid, 1060) == 23) then
			...
			selfSay("I need you to enter ze zity and zlay at leazt zix noblez. Ze otherz will feel zreatened and call guardz to zemzelvez, and ze dragon kingz will accuze each ozer to be rezponzible for zlaying zeir pet noblez. ...", cid)
		...
		elseif(getPlayerStorageValue(cid, 1060) == 26) then
			...
			selfSay("A large number of rebelz have arrived undercover in ze zity. Zey will attack ze palaze and zome loyal palaze guardz will let zem in. ...", cid)
			selfSay("Meanwhile, you will take ze old ezcape tunnel zat leadz from ze abandoned bazement in ze norz of ze miniztry to a lift zat endz zomewhere in ze palaze. ...", cid)
