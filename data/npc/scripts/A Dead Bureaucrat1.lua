...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "411") then
		if player:getStorageValue(Storage.pitsOfInfernoPumin) == 3 then
			npcHandler:say("Form 411? You need Form 287 to get that! Do you have it?", cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(Storage.pitsOfInfernoPumin) == 5 then
			npcHandler:say("Form 411? You need Form 287 to get that! Do you have it?", cid)
	...
	elseif msgcontains(msg, "356") then
		if player:getStorageValue(Storage.pitsOfInfernoPumin) == 8 then
