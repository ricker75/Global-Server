...
function creatureSayCallback(cid, type, msg)
	...
	if (msgcontains(msg, 'mission')) and getPlayerStorageValue(cid, 95591) < 1 then
		...
		setPlayerStorageValue(cid, 95591, 1)
		setPlayerStorageValue(cid, 82960, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 4) then
		...
		setPlayerStorageValue(cid, 95592, 5)
		setPlayerStorageValue(cid, 82960, getPlayerStorageValue(cid, 82960) + 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 5) then
		...
		setPlayerStorageValue(cid, 95592, 6)
		setPlayerStorageValue(cid, 82961, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 8) and getPlayerItemCount(cid, 10167) >= 1 then
		...
		setPlayerStorageValue(cid, 95592, 9)
		setPlayerStorageValue(cid, 82961, 3) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 9) then
		...
		setPlayerStorageValue(cid, 95592, 10)
		setPlayerStorageValue(cid, 82962, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 10) and getPlayerItemCount(cid, 10169) >= 10 then
		...
		setPlayerStorageValue(cid, 95592, 11)
		setPlayerStorageValue(cid, 82962, 2) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 11) then -- mission 04 start
		...
		setPlayerStorageValue(cid, 95592, 12)
		setPlayerStorageValue(cid, 82963, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 12) and getPlayerItemCount(cid, 10151) >= 6 then
		...
		setPlayerStorageValue(cid, 95592, 13)
		setPlayerStorageValue(cid, 82963, 2) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 13) then -- mission 05 start
	...
	elseif(getPlayerStorageValue(cid, 95592) == 16) then -- mission 06 start
		...
		setPlayerStorageValue(cid, 95592, 17)
		setPlayerStorageValue(cid, 82965, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 17) and getPlayerItemCount(cid, 10165) >= 1 then
		...
		setPlayerStorageValue(cid, 95592, 18)
		setPlayerStorageValue(cid, 82965, 2) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 18) then -- mission 07 start
		...
		setPlayerStorageValue(cid, 95592, 19)
		setPlayerStorageValue(cid, 82966, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 19) and getPlayerItemCount(cid, 10170) >= 1 then
		...
		setPlayerStorageValue(cid, 95592, 20)
		setPlayerStorageValue(cid, 82966, 2) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 20) then -- mission 08 start
		...
		setPlayerStorageValue(cid, 95592, 21)
		setPlayerStorageValue(cid, 82967, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 21) and getPlayerItemCount(cid, 10166) >= 1 then
		...
		setPlayerStorageValue(cid, 95592, 22)
		setPlayerStorageValue(cid, 82967, 2) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 22) then -- mission 09 start
		...
		setPlayerStorageValue(cid, 95592, 23)
		setPlayerStorageValue(cid, 82968, getPlayerStorageValue(cid, 82968) + 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 24) then
		...
		setPlayerStorageValue(cid, 95592, 25)
		setPlayerStorageValue(cid, 82968, getPlayerStorageValue(cid, 82968) + 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 25) then
		...
		setPlayerStorageValue(cid, 95592, 26)
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 27) and getPlayerItemCount(cid, 10157) >= 1 then
		...
		setPlayerStorageValue(cid, 95592, 28)
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 28) then
		npcHandler:say("Are you up to your second assignment?", cid)
		setPlayerStorageValue(cid, 95592, 29)
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 30) and getPlayerItemCount(cid, 10155) >= 1 then
		npcHandler:say("Ah, a perfect shadow orb! This is exactly what we need.", cid)
		doPlayerRemoveItem(cid, 10155, 1)
		setPlayerStorageValue(cid, 95592, 31)
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 31) then
		npcHandler:say("Ready for your third assignment?", cid)
		setPlayerStorageValue(cid, 95592, 32)
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 33) and getPlayerItemCount(cid, 10159) >= 1 then
		...
		setPlayerStorageValue(cid, 95592, 34)
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 34) then
		...
		setPlayerStorageValue(cid, 95592, 35)
		setPlayerStorageValue(cid, 82969, 2) -- quest log
		npcHandler.topic[cid] = 0
	-- finish mission 10 -- start mission 11 --
	elseif(getPlayerStorageValue(cid, 95592) == 35) then -- mission 11 start
		...
		setPlayerStorageValue(cid, 95592, 36)
		setPlayerStorageValue(cid, 82970, 1) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 37) then
		...
		setPlayerStorageValue(cid, 95592, 38)
		npcHandler.topic[cid] = 0
	-- finish mission 11 -- start mission 12 --
	elseif(getPlayerStorageValue(cid, 95592) == 39) and getPlayerItemCount(cid, 10173) >= 1 then
		...
		setPlayerStorageValue(cid, 95592, 40)
		setPlayerStorageValue(cid, 82971, 2) -- quest log
		npcHandler.topic[cid] = 0
	elseif(getPlayerStorageValue(cid, 95592) == 40) then
		...
		setPlayerStorageValue(cid, 95592, 41)
		setPlayerStorageValue(cid, 82972, 1) -- quest log
		npcHandler.topic[cid] = 0
	-- finish mission 12 --
	elseif(msgcontains(msg, "yes")) then
		if(getPlayerStorageValue(cid, 95592) == 26) then
			...
			setPlayerStorageValue(cid, 95592, 27)
			setPlayerStorageValue(cid, 82969, 1) -- quest log
			npcHandler.topic[cid] = 0
		elseif(getPlayerStorageValue(cid, 95592) == 29) then
			...
			setPlayerStorageValue(cid, 95592, 30)
			npcHandler.topic[cid] = 0
		elseif(getPlayerStorageValue(cid, 95592) == 32) then
			...
			setPlayerStorageValue(cid, 95592, 33)
			npcHandler.topic[cid] = 0
		elseif(getPlayerStorageValue(cid, 95592) == 38) then
			...
			setPlayerStorageValue(cid, 95592, 39)
