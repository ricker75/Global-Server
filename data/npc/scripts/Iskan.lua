...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(120) >= 8 then -- if Barbarian Test absolved 
			if player:getStorageValue(12001) < 1 then
				selfSay("Well, one of the boys has run away. I think he got the scent of some beast. He's young and inexperienced so I can't blame the cub ...", cid)
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			selfSay("That's surprising. Take a piece of meat. If you find the boy, feed it to him. That will give him enough strength and incentive to return to his pack ...", cid)
