...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'disguise') then
		if player:getStorageValue(Storage.thievesGuild.TheatreScript) < 0 then
			selfSay("Hmpf. Why should I waste my time to help some amateur? I\'m afraid I can only offer my assistance to actors that are as great as I am. ...", cid)
			npcHandler:say("Though, your futile attempt to prove your worthiness could be amusing. Grab a copy of a script from the prop room at the theatre cellar. Then talk to me again about your test!", cid)
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 11 then
			...
			player:addAchievement(4) -- Achievement Amateur Actor
