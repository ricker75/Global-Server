...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'yes') then
		if npcHandler.topic[cid] == 2 then
			selfSay("That\'s just incredible! I\'ve dreamed about acquiring the dwarven bridge since I was a child! Now my dream will finally become true. ...", cid)
			npcHandler:say("And you are sure you want to sell it? I mean really, really sure?", cid)
		...
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(8694, 1) then
				...
				selfSay("Excellent! Here is the painting you requested. It\'s quite precious to my father, but imagine his joy when I tell him about my clever deal! ...", cid)
				npcHandler:say("Now leave me alone please. I have to prepare for my departure. Now my family will not call me a squandering fool anymore!", cid)
