	...
	elseif msgcontains(msg, "exit") then
		if player:getStorageValue(1066) < 1 then
			...
			elseif npcHandler.topic[cid] == 14 then	
				selfSay("Alright, as I said you are free now. There will not be an outside for the next three centuries, but you - go. ...", cid)
				npcHandler:say("Oh and I recovered the strange crate you where hiding in, it will wait for you at the exit since you can't carry it as... a beetle, muhaha. Yes, you shall now crawl through the passage as a beetle. There you go.", cid)
