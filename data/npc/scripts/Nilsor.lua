...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(12001) == 20 then
			selfSay("I am in dire need of help. A plague has befallen my dogs. I even called a druid of Carlin for help but all he could do was to recommend some strong medicine ...", cid)
			selfSay("The thing is the ingredients of the medicine are extremely rare and some only exist in far away and distant lands. If you could help me collecting the ingredients, I would be eternally grateful ...", cid)
			npcHandler:say("Are you willing to help me?", cid)
			npcHandler.topic[cid] = 1
		elseif player:getStorageValue(12001) == 28 then
			selfSay("Thank you. Now I have all necessary ingredients. As a reward I grant you the use of our dog sled, which is located to the east of here. ...", cid)
	...
	elseif msgcontains(msg, "water") then
		if player:getStorageValue(12001) == 22 then
			selfSay("You will need a specially prepared waterskin to collect the water. You can buy one from me ...", cid)
			npcHandler:say("Use it on a geyser that is NOT active. The water of active geysers is far too hot. You can find inactive geysers on Okolnir. Do you have some geyser water with you?", cid)
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			selfSay("A thousand thanks in advance. I need no less than 7 ingredients for the cure. You can ask me about each specifically ...", cid)
			selfSay("I need a part of the sun adorer cactus, a vial of geyser water, sulphur of a lava hole, a frostbite herb, a blossom of a purple kiss, a hydra tongue and spores of a giant glimmercap mushroom ...", cid)
			npcHandler:say("Turn them in individually by talking about them to me. As soon as I obtained them all, talk to me about the medicine. First time bring a Part of the Sun Adorer {Cactus}.", cid)
