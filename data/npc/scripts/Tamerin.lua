...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if(p:getStorageValue( 30) == 29) then
			selfSay("Why should I do something for another human being? I have been on my own for all those years. Hmm, but actually there is something I could need some assistance with. ...", cid)
