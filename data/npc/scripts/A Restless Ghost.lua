...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "story") then
		if player:getStorageValue(12001) == 37 then
			selfSay("I was captured and tortured to death by the cultists here. They worship a being that they call Ghazbaran ...", cid)
			selfSay("In his name they have claimed the mines and started to melt the ice to free an army of vile demons that have been frozen here for ages ...", cid)
