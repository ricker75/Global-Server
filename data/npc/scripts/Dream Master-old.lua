...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "join")) then
		if(getPlayerStorageValue(cid, 67) < 1 and getPlayerStorageValue(cid, 66) < 1) then
			selfSay("The Nightmare Knights are almost extinct now, and as far as I know I am the only teacher that is left. But you might beright and its time to accept new disciples ... ", cid)
			selfSay("After all you have passed the Dream Challenge to reach this place, which used to be the process of initiation in the past... ", cid)
			selfSay("So I ask you: do you wish to become a member of the ancient order of the Nightmare Knights, " .. getCreatureName(cid) .."?", cid)
	...
	elseif(msgcontains(msg, "yes")) then
		...
		elseif(npcHandler.topic[cid] == 2) then
			selfSay("So I welcome you as the latest member of the order of the Nightmare Knights. You entered this place as a stranger, butyou will leave this place as a friend ... ", cid)
