function onUse(cid, item, fromPosition, itemEx, toPosition)
	if(item.uid == 3070) then
		if(getTileItemById({x = 33276, y = 32444, z = 8}, 3697).uid > 0 and getTileItemById({x = 33278, y = 32450, z = 8}, 3697).uid > 0 and getTileItemById({x = 33284, y = 32450, z = 8}, 3697).uid > 0 and getTileItemById({x = 33281, y = 32442, z = 8}, 3698).uid > 0 and getTileItemById({x = 33286, y = 32444, z = 8}, 3698).uid > 0) then
